    ...
    <main class="main">
        ...
        <section id="hero" class="hero section">
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 ">
                        <h1>Grow your bussiness with My</h1>
                        <p>We are team of talented designers making websites with Bootrap</p>
                        <div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container">
        ...
        <section id="stats" class="stats section">
            <div class="container" data-aos="fade-up" data-aos-deley="100">
                        ...
                        <div class="row gy-4">
                                ...
                                <div class=" stats-item d-flex">
                                    ...
                                    <div>
                                        <span data-purecounter-start="0" data-purecounter-end="232"
                                            data-purecounter-duration="1" class="purecounter">232</span>
                                        <p><strong>Happy Client</strong> <span>The Next one</span></p>
                                    </div>
                                </div>
                            </div> <!-- End Stats Item -->
                            ...
                            <div class="col-lg-6">
                                <div class="stats-item d-flex">
                                    ...
                                    <div>
                                        <span data-purecounter-start="" data-purecounter-end=""
                                            data-purecounter-duration="" class="purecounter">521</span>
                                        <p><strong>Project</strong> <span>Make great your project</span></p>
                                    </div>
                                </div>
                            </div> <!-- End Stats Item -->
                            ...
                            <div class="col-lg-6">
                                <div class="stats-item d-flex">
                                    ...
                                    <div>
                                        <span data-purecounter-start="" data-purecounter-end=""
                                            data-purecounter-duration="1" class="purecounter">1453</span>
                                        <p><strong>Hours Of Support</strong> <span>Relax in free time</span></p>
                                    </div>
                                </div>
                            </div> <!-- End Stats Item -->
                            ...
                            <div class="col-lg-6">
                                <div class="stats-item d-flex">
                                    ...
                                    <div>
                                        <span data-purecounter-start="" data-purecounter-end=""
                                            data-purecounter-duration="" class="purecounter">32</span>
                                        <p><strong>Hard Workers</strong> <span>Hard Work when do</span></p>
                                    </div>
                                </div>
                            </div> <!-- End Stats Item -->
                        </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex">
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="" class="stretched-link">Welcome to website</a></h4>
                            <p>Fear makes people weak but also makes them stronger.</p>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex">
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="" class="stretched-link">To be See</a></h4>
                            <p>Don't be afraid of failure. Just do it, success is waiting for you</p>
                        </div>
                    </div> <!-- End Service Item -->
                    ...
                    <div class="col-xl-3 col-md-6 d-flex">
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="" class="stretched-link">Sorrows</a></h4>
                            <p>Sadness does not make us lose faith in life but makes us try harder. </p>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex">
                        <div class="service-item position-relative">
                            ...
                            <p>Don't let loneliness get you down. just do it be happy and you feel great</p>
                        </div>
                    </div><!-- End Service Item -->
                </div>
            </div>
                ...
                <div class="row gy-4">
                        ...
                        <div class="service-item position-relative">
                            ...
                            <div class="details">
                                <a href="service-details.html" class="stretched-link">
                                    <h3>They don't know how to harvest.</h3>
                                </a>
                                <p>They provide nothing less than those who will follow, not all greater. Those who
                                    accuse them are less likely to suffer pains by right.</p>
                            </div>
                        </div>
                    </div> <!-- End Service Item-->
                        ...
                        <div class="service-item position-relative">
                            ...
                            <div class="details">
                                <a href="" class="stretched-link">
                                    <h3>The Lord of Comfort</h3>
                                </a>
                                <p>As but or but not a. Let them be easy for just let them be. Free corrupt or him here
                                    not as they do not know pain.</p>
                            </div>
                        </div>
                    </div> <!-- End Service Item -->
                    ...
                    <div class="col-lg-6">
                        <div class="service-item position-relative">
                            ...
                            <div class="details">
                                ...
                                <p>As they will except pleasure unless but. Indeed flight follow. Less it or. Or who
                                    that pleasure obtain them their corrupt.</p>
                            </div>
                        </div>
                    </div> <!-- End Service Item-->
                    ...
                    <div class="col-lg-6">
                        <div class="service-item position-relative">
                            ...
                            <div class="details">
                                <a href="service-details.html" class="stretched-link">
                                    <h3>It is more convenient to be rough</h3>
                                </a>
                                <p>Not and times less all but pain be follow. With desire error that flight be provide
                                    obtain nor.</p>
                            </div>
                        </div>
                    </div> <!-- End Service Item-->
        ...
        </section><!-- Alt Services Section End -->
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-3 col-md-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="features-item">
                            <i class="fa-solid fa-eye" style="color: #ffbb2c;"></i>
                    ...
                    <div class="col-lg-3 col-md-4" data-aos="fade-up" data-aos-delay="400">
                        <div class="features-item">
                            <i class="fa-solid fa-hexagon-nodes" style="color: #e361ff;"></i>
                    ...
                    <div class="col-lg-3 col-md-4" data-aos="fade-up" data-aos-delay="600">
                        <div class="features-item">
                            <i class="fa-solid fa-star" style="color: #ffa76e;"></i>
                    ...
                    <div class="col-lg-3 col-md-4" data-aos="fade-up" data-aos-delay="900">
                        <div class="features-item">
                            <i class="fa-solid fa-code-compare" style="color: #b2904f;"></i>
                    ...
                    <div class="col-lg-3 col-md-4" data-aos="fade-up" data-aos-delay="1000">
                        <div class="features-item">
                            <i class="fa-solid fa-basketball" style="color: #b20969;"></i>
                    ...
                    <div class="col-lg-3 col-md-4" data-aos="fade-up" data-aos-delay="1100">
                        <div class="features-item">
                            <i class="fa-solid fa-wave-square" style="color: #ff5828;"></i>
                    ...
                    <div class="col-lg-3 col-md-4" data-aos="fade-up" data-aos-delay="1200">
                        <div class="features-item">
                            <i class="fa-regular fa-sun" style="color: #29cc61;"></i>
